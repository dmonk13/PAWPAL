  ...
  return (
    ...
    >
      <div className="relative h-full">
        ...
        {/* Enhanced Profile info with Hinge-inspired design */}
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white/95 to-transparent p-6">
          <div className="mb-4">
            ...
            <div className="flex items-center space-x-2 mb-3">
              <Badge className="bg-slate-100 text-slate-700 border-slate-200 px-3 py-1.5 font-medium text-sm">
                {dog.breed}
              </Badge>
              <Badge className="bg-rose-100 text-rose-700 border-rose-200 px-3 py-1.5 font-medium text-sm">
                {dog.size}
              </Badge>
              <Badge className="bg-amber-100 text-amber-700 border-amber-200 px-3 py-1.5 font-medium text-sm">
                {dog.gender}
              </Badge>
            </div>
            
            {dog.bio && (
              <p className="text-sm text-gray-700 line-clamp-2 leading-relaxed font-medium bg-white/80 backdrop-blur rounded-lg p-3 border border-gray-200/50 shadow-sm">{dog.bio}</p>
            )}
          </div>
        </div>
